      ...
      <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6">
        ...
        <div className="rounded-2xl border border-border bg-card p-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {mode === "signin"
              ? "Melde dich an, um deine Videos zu schneiden."
              : "Starte in Sekunden. Kein Kreditkarte."}
          </p>

          <button
            onClick={handleGoogle}
            disabled={busy}
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-md border border-border bg-background px-4 py-2.5 text-sm font-medium hover:bg-secondary disabled:opacity-60"
          >
            <svg width="18" height="18" viewBox="0 0 24 24">
              <path
                fill="#4285F4"
                d="M22.5 12.3c0-.8-.1-1.5-.2-2.2H12v4.2h5.9c-.3 1.3-1 2.4-2.1 3.2v2.7h3.4c2-1.9 3.3-4.6 3.3-7.9z"
              />
              <path
                fill="#34A853"
                d="M12 23c2.8 0 5.2-.9 6.9-2.5l-3.4-2.7c-.9.6-2.1 1-3.5 1-2.7 0-5-1.8-5.8-4.3H2.7v2.7C4.4 20.6 8 23 12 23z"
              />
              <path
                fill="#FBBC05"
                d="M6.2 14.5c-.2-.6-.3-1.3-.3-2s.1-1.4.3-2V7.8H2.7C1.9 9.3 1.5 11 1.5 12.5s.4 3.2 1.2 4.7l3.5-2.7z"
              />
              <path
                fill="#EA4335"
                d="M12 6c1.5 0 2.9.5 4 1.5l3-3C17.2 2.8 14.8 2 12 2 8 2 4.4 4.4 2.7 7.8l3.5 2.7C7 7.9 9.3 6 12 6z"
              />
            </svg>
            Weiter mit Google
          </button>
          ...
          <div className="my-5 flex items-center gap-3 text-xs text-muted-foreground">
            <div className="h-px flex-1 bg-border" /> oder E-Mail{" "}
