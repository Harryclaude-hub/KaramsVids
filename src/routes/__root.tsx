    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold text-foreground">
          Da ist beim Rendern etwas gerissen.
        </h1>
  ...
  head: () => ({
    meta: [
      ...
      { title: "VideoCraft AI — KI-Videoschnitt für UGC & Shorts" },
      {
        name: "description",
        content:
          "Lade Rohvideos hoch, lass die KI Highlights finden, schneide UGC-Shorts mit Untertiteln und veröffentliche direkt auf TikTok, YouTube, Instagram & Co.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/eeb957a4-2f24-47c3-b3fa-46bbd827b429/id-preview-be665e35--110c9ea8-91da-4cb4-8c6a-4aa4858912b8.lovable.app-1784588641196.png",
      },
      {
        name: "twitter:image",
        content:
