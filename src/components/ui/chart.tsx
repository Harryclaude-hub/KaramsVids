  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-[14px] border border-border/50 bg-background px-2.5 py-1.5 text-[12px] shadow-[0_12px_40px_-12px_rgba(0,0,0,0.18)]",
          className,
        )}
      >
